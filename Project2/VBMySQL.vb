...
Public Class VBMySQL
    ...
    Public Property Database = "order"
    ...
    Public Function Retrieve_Table(SQLStatement As String) As DataTable
        ...
        Catch ex As Exception
            MessageBox.Show("The data reading process failed." & vbCrLf & "Error Number = " & Err.Number & vbCrLf & ex.Message, "Sorry", MessageBoxButtons.OK, MessageBoxIcon.Error)
            table = Nothing
        Finally
    ...
    Public Function Delete_Row(SQLStatement As String) As Boolean
        ...
        Try
            ...
            Delete_Row = True
        Catch ex As MySqlException
            MessageBox.Show("Failed to delete." & vbCrLf & "Error Number = " & Err.Number & vbCrLf & ex.Message, "Sorry", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Delete_Row = False
        Finally
            MySQL_Connection.Dispose()
            MySQL_Connection = Nothing
